...
//=============================================================================
int TcCmds_cmdEx::log_widget_visibility(TcCmdContext* /*context*/, TcArgCol& args)
{
    if (args.count() <= 1) return args.appendError("log_widget_visibility"
                                  " command must have argument show/hide");

    if (string("show") ==args.at(1)->value()) {
