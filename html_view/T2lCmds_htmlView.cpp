...
//=============================================================================
bool Cmds_htmlView::registrator_ = Cmds_htmlView::registerCmds_();

//=============================================================================
Cmds_htmlView::Cmds_htmlView()
{
}

//🔴=============================================================================
int Cmds_htmlView::set_current_tab(TcCmdContext* /*context*/, TcArgCol& args)
{   if (args.count() < 1) return args.appendError("tab name must be entered");
    TcArg* val = args.at(1);
    if (val == nullptr) return args.appendError("tab name must be value");
    assert(0);
    //APTA2 TcHtmlViewTabbed::mainView().tabSetCurrent(val->value());
    return 0;
}

//🔴=============================================================================
QString Cmds_htmlView::displayCmdLine(bool isCmd)
{
    QString result;
...
//🔴=============================================================================
QString Cmds_htmlView::displayExecutedCmds()
{
    QString result;

    result.append("<div>");

    TcCmdLog* log = HtmlTabsRegistry::instance().log_;

    for ( long i = log->count()-1; ( (i > log->count()-49) && (i >=0) ) ; i-- )
    {
        result.append("<b>");
...
//🔴=============================================================================
int Cmds_htmlView::tab_set_commands(TcCmdContext* /*context*/, TcArgCol& /*args*/)
{
    //APTA2 TcHtmlViewTabbed::mainView().tabSet("commands", displayCmdLine(false).toLatin1().data());
    HtmlTab* tab = HtmlTabsRegistry::instance().tabGet_("commands");
    tab->contentSetEx(displayCmdLine(false).toStdString());
    return 0;
}

//🔴=============================================================================
int Cmds_htmlView::tab_set_log(TcCmdContext* /*context*/, TcArgCol& /*args*/)
{   QString LOGSTR;
    TcCmdLog* log = HtmlTabsRegistry::instance().log_;

    for ( long i = 0; i < log->count(); i++ )
    {   if ( log->at(i).isFrontController() == false ) continue;
        LOGSTR.append(QString("[%0]").arg(i));
        LOGSTR.append(log->at(i).cmdRecord());
        LOGSTR.append("<br>");
    }

    //APTA2 TcHtmlViewTabbed::mainView().tabSet("log", LOG.toLatin1().data());
    HtmlTab* tab = HtmlTabsRegistry::instance().tabGet_("log");
    tab->contentSetEx(LOGSTR.toStdString());

    return 0;
}

//🔴=============================================================================
int Cmds_htmlView::tab_set_executed(TcCmdContext* /*context*/, TcArgCol& /*args*/)
{
    QString result;
...
//🔴=============================================================================
int Cmds_htmlView::tab_set_info(TcCmdContext* /*context*/, TcArgCol& /*args*/)
{   QString result;
    ...
    //APTA2 TcHtmlViewTabbed::mainView().tabSet("info", result.toLatin1().data());
    HtmlTab* tab = HtmlTabsRegistry::instance().tabGet_("info");
    tab->contentSetEx(result.toStdString());
...
//=============================================================================
/*int TcCmds_htmlView::filesys_select_file(TcCmdContext*, TcArgCol& args)
{
...
//🔴=============================================================================
int Cmds_htmlView::html_view_tab_selector(TcCmdContext* /*context*/, TcArgCol& args)
{
    if (args.count() < 1) return args.appendError("directory name must be entered");
    TcArgVal* val = args.at(1);
...
//🔴=============================================================================
int Cmds_htmlView::set_main_tab(TcCmdContext* context, TcArgCol& args)
{
